                    ...
                    <div class="-m-2">
                      ...
                      <div class="p-2 w-2/3 mx-auto">
                        <div class="relative">
                          ...
                          <textarea id="information" name="information" required class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{{ $shop->information }}</textarea>
                      ...
                      <div class="flex justify-around mt-6 p-2 w-full">
                        <button type="button" onClick="location.href='{{ route('owner.shops.index') }}'" class="text-black bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-300 rounded text-lg">戻る</button>
