              ...
              <div class="p-6 bg-white border-b border-gray-200">
                  <section class="text-gray-600 body-font">
                      <div class="container px-5 mx-auto">
                          ...
                          <div class="lg:w-2/3 w-full mt-4 mx-auto overflow-auto">
                              <table class="table-auto w-full text-left whitespace-no-wrap">
                                  ...
                                  <tbody>
                                      @foreach ($expiredOwners as $owner)
                                          <tr>
                                              <td class="border-t-2 border-b-2 border-gray-200 px-4 py-3">{{ $owner->name }}</td>
                                              <td class="border-t-2 border-b-2 border-gray-200 px-4 py-3">{{ $owner->email }}</td>
                                              <td class="border-t-2 border-b-2 border-gray-200 px-4 py-3">{{ $owner->deleted_at->diffForHumans() }}</td>
