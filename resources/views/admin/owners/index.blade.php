                              ...
                              <table class="table-auto w-full text-left whitespace-no-wrap">
                                  ...
                                  <tbody>
                                      @foreach ($owners as $owner)
                                          <tr>
                                              <td class="border-t-2 border-b-2 border-gray-200 md:px-4 py-3">{{ $owner->name }}</td>
                                              <td class="border-t-2 border-b-2 border-gray-200 md:px-4 py-3">{{ $owner->email }}</td>
                                              <td class="border-t-2 border-b-2 border-gray-200 md:px-4 py-3">{{ $owner->created_at->diffForHumans() }}</td>
