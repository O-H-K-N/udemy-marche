                        ...
                        <div class="lg:w-1/2 md:w-2/3 mx-auto">
                          <div class="-m-2">
                            ...
                            <div class="flex justify-around mt-6 p-2 w-full">
                              <button onClick="location.href='{{ route('admin.owners.index') }}'" class="text-black bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-300 rounded text-lg">戻る</button>
